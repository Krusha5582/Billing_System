...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Insert question
    public long insertQuestion(int examId, String questionText,
    ...
    public Cursor getAllExams() {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery("SELECT * FROM " + TABLE_EXAM, null);
    }

    // Get all questions of a specific exam
    public Cursor getQuestionsByExamId(int examId) {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery("SELECT * FROM " + TABLE_QUESTION + " WHERE " + COL_EXAM_ID + " = ?",
